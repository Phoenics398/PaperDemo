...
本示例展示了 PaperDemo 操作 docx 的第二种方式。
"""
...
# -------------------- 正文 --------------------
# 格式：以 wt1| 开头，后面跟着标题内容，以 <!> 结尾换行
px = "wt1|身边的微党课系列——<!>"
b001 = cv(px, maps)

px = "wt1|刺激消费信心 坚定制度自信<!>"
b002 = cv(px, maps)

# 格式：以 wh1| 开头，后面跟着标题内容，以 <!> 结尾换行
px = "wh1|一、理论引领：习近平总书记关于消费的重要论述指引方向<!>"
b003 = cv(px, maps)

# 格式：以 wp1| 开头，后面跟着段落内容，以 <!> 结尾换行
px = "wp1|关于刺激消费的问题，以习近平总书记为核心的党中央，早就指明了方向。<!>"
b004 = cv(px, maps)

px = "wp1|总书记指出：“要坚决贯彻落实扩大内需战略规划纲要，尽快形成完整内需体系，着力扩大有收入支撑的消费需求。”这一重要论述从理论高度阐明了消费在经济运行中的核心价值。<!>wp1|总书记还强调：“中国是全球第二大消费市场，拥有全球最大规模中等收入群体，蕴含着巨大投资和消费潜力。”这不仅为我们认识消费的重要地位提供了根本遵循，更让我们对破解刚才提到的消费疲软问题充满信心。<!>"
b005 = cv(px, maps)
...
fileName = f'ex02_{paperName}.docx'
